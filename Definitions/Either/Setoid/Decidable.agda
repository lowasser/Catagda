...
module Definitions.Either.Setoid.Decidable {ℓA ℓ=A ℓB ℓ=B : Level} (A : Set ℓA) (B : Set ℓB) {{DSA : DecidableSetoid ℓ=A A}} {{SB : DecidableSetoid ℓ=B B}} where
...
open import Definitions.Either.Setoid {ℓA} {ℓ=A} {ℓB} {ℓ=B} A B
