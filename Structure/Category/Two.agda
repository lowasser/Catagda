module Structure.Category.Two where
...
open import Relation.Equivalence.Structural.Properties TwoOb
...
private
    ...
    =Arrow-equivalence {a} {b} = equiv where
        open import Relation.Equivalence.Structural.Properties (a ⟶ b) renaming (≡-Equivalence to equiv)
