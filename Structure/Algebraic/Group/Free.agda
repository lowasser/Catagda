...
module Structure.Algebraic.Group.Free {ℓA ℓ=A : Level} (A : Set ℓA) {{SA : Setoid ℓ=A A}} where
...
open import Data.List.Reverse.Properties {ℓA} {ℓ=A} Letter
open import Data.Either.Setoid {ℓA} {ℓ=A} {ℓA} {ℓ=A} A A
open import Data.List.Setoid {ℓA} {ℓ=A} Letter
open import Data.List.Concatenation.Properties {ℓA} {ℓ=A} Letter
open import Data.List.Properties {ℓA} {ℓ=A} Letter
open import Data.List.Map.Properties {ℓA} {ℓ=A} {ℓA} {ℓ=A} Letter Letter
